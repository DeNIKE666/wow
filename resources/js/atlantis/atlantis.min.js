...
$(".nav-search .input-group > input").focus(function (a) {
    ...
    if (!g) {
        ...
        $(".wrapper").hasClass("sidebar_minimize") && (v = 1, k.addClass("toggled"), k.html('<i class="fad fa-align-left"></i>')), k.on("click", function () {
            1 == v ? ($(".wrapper").removeClass("sidebar_minimize"), k.removeClass("toggled"), k.html('<i class="fad fa-align-right"></i>'), v = 0) : ($(".wrapper").addClass("sidebar_minimize"), k.addClass("toggled"), k.html('<i class="fad fa-align-left"></i>'), v = 1), $(window).resize()
        }), g = !0
    }
    if (!p) {
